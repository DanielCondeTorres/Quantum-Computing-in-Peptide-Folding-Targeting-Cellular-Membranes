...
class Peptide:
    ...
    def __init__(
        ...
        self.main_chain_residue_sequence = main_chain_residue_sequence
...
#Funcion para obtener en cualquier clase la secuencia de aa
    def residue_sequence(self)->Sequence[MainChain]:
        return self.main_chain_residue_sequence 
